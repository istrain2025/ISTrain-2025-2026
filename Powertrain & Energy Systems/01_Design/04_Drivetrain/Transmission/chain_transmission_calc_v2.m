...
% STAGE 1
speed_stage1 = speed_max/g1;       % jackshaft speed
T_stage1 = Tm*g1;
power_stage1 = f1*f2_stage1*speed_stage1*Tm;

% STAGE 2
speed_stage2 = speed_stage1/g2;
power_output = f1*f2_stage2*speed_stage2*T_stage1; % total power output of the vehicle
power_per_wheelset = power_output/2;

%% ---------- PITCH ----------
% choose pitch from power and speed needed
p = 9.525;      % mm - 06B pitch
C = 40*p;       % center distance in pitches
